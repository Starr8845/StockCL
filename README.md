...
<img src="pics/formula.png" width = "400"  alt="Evaluation metics." align=center />
...
To run the project, you should first refer to qlib, download the standard dataset and prepare the environment. Then run the script
